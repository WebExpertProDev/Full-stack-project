  ...
  <section className="wow fadeInUp">
    <Container className="px-lg-0" fluid="lg">
      <Row className="justify-content-center mt-5">
        <Col lg="3" md="4" sm="7" xs="11" className="d-flex flex-column align-items-center justify-content-center mt-4">
      ...
      <Row className="justify-content-center mt-5">
        <Col lg="9" md="12" sm="7" xs="11">
          <Button handleClick={() => changePageHandler(5)}>select</Button>
        </Col>
      </Row>
    </Container>
  </section>
